...
namespace DataTamer
{
                                       ...
                                       const std::string& topic_prefix)
  {
    ...
    schema_publisher_ = node->create_publisher<data_tamer_msgs::msg::Schemas>(topic_prefix + "/schemas", schemas_qos);
    data_publisher_ = node->create_publisher<data_tamer_msgs::msg::Snapshot>(topic_prefix + "/data", data_qos);
  }  

  void ROS2PublisherSink::addChannel(const std::string& channel_name,
  const Schema& schema)
  {
